...
public class IabHelper {
    ...
    void flagStartAsync(String operation) {
        if (mAsyncInProgress) {
//            Toast.makeText(mContext, "Can't start async operation (" + operation + ") because another async operation(" + mAsyncOperation + ") is in progress.", Toast.LENGTH_LONG).show();
            Log.e("error", "Can't start async operation (" + operation + ") because another async operation(" + mAsyncOperation + ") is in progress.");
        } else {
